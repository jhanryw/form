...
export const trafegoGeralForm: FormConfig = {
  id: "Geral",
  slug: "geral",
  niche: "geral",
  version: "1.0.0",
  theme: {
    primaryColor: "#1877F2",
    primaryColorHover: "#1877F2",
    onPrimaryColor: "#ffffff",
  },
  cover: {
    headline: "🚀 Escale suas vendas com especialistas em Tráfego Pago.",
    subtitle:
      "",
    bullets: [
      "💰 Buscamos mais retorno nos anúncios",
      "📱 Criativos por nossa conta",
      "📊 Tenha estratégia e acompanhamento",
      "🏆 Método Validado",
    ],
    qualificationFooter:
      "→ Para empresas que já investe em anúncios on-line",
