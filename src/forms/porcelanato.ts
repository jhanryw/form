...
export const trafegoPorcelanatoForm: FormConfig = {
  id: "Porcelanato",
  slug: "porcelanato",
  niche: "porcelanato",
  version: "1.0.0",
  ...
  cover: {
    headline: "🏠 Transforme reformas em pedidos de porcelanato com Tráfego Pago.",
    subtitle:
      "",
    bullets: [
      "🏠 Leads construindo ou reformando",
      "🔥 Clientes procurando grandes formatos e acabamentos",
      "✅ Tráfego pensado para lojas de revestimentos",
      "🏆 Método Validado",
    ],
    qualificationFooter:
